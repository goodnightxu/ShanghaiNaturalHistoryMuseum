...
- (id)initWithFrame:(CGRect)frame datePermanentStoreKey:(NSString *)datePermanentStoreKey
{
    ...
    {
        self.releaseText = NSLocalizedString(@"释放更新", @"Release to refresh status");
        self.pullDownText = NSLocalizedString(@"下拉更新", @"Pull down to refresh status");
        self.loadingText = NSLocalizedString(@"加载中...", @"Loading Status");
        self.dateFormatterText = @"MM/dd/yyyy hh:mm:a";
        self.refreshDateFormatText = @"最后更新: %@";
